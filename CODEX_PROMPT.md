# Build Task: invoice-payment-predictor

Build a complete, production-ready Next.js 15 App Router application.

PROJECT: invoice-payment-predictor
HEADLINE: Predict which invoices will be paid late
WHAT: Analyzes client payment history, invoice amounts, and timing patterns to predict payment delays and suggest collection actions
WHY: Cash flow issues from late payments kill 82% of small businesses, but most don't track payment patterns systematically
